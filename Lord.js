...
prefa = "!"
enter = '\n'
notnot = `*NOTE:*${enter}*MAU CARI GROUP ISIAN FREE FIRE? KLIK LINK DI BAWAH! https://chat.whatsapp.com/EONNTKhofxIEAqoY1JA6jD`
...
•> 5k / BULAN (PREMIUM)
LANGSUNG KETIK .owner jika mau sewa
...
Alasan : ${reason}`, [sender], true)
						...
						case 'sewabot': 
									let gakloo = [{
										...
										break
						case 'donasi':
									reply('*DANA/OVO/TELKOMSEL : 082135304765*')
									break
...
let qqppp = [{
                ...
                sendButLocation(from, teks, `©𝘽𝘼𝙂𝙊𝙇 𝙋𝙀𝙉𝙂𝙊𝙈𝘾𝙊𝙆 𝙃𝘼𝙈𝘿𝘼𝙇 | Allright Reserved.`, thumbnail, qqppp, {contextInfo: { mentionedJid: [nupe]}})
